# Generated by Powerlevel10k configuration wizard on 2022-04-05 at 23:22 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 53041.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, slanted separators, sharp heads, round tails, 1 line, sparse, many icons,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIRENV_BACKGROUND=4
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_ASDF_NODEJS_BACKGROUND='#2B7117'
  ...
  typeset -g POWERLEVEL9K_NODENV_BACKGROUND=1
  ...
  typeset -g POWERLEVEL9K_NODE_VERSION_BACKGROUND='#3EB15D'
